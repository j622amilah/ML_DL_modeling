...
public class WekaWrapper2 {
	...
	private static WekaWrapper2 singleton = new WekaWrapper2();

	/*
	 * A private Constructor prevents any other class from instantiating.
	 */
	private WekaWrapper2() {

	}

	/* Static 'instance' method */
	public static WekaWrapper2 getInstance() {
		return singleton;
	}
	...
	public double handleRegression(int targetDatacenter, double[] values) {
		...
		String filename_edge = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_edge_regression.txt";
		String filename_cloud_rsu = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_rsu_regression.txt";
		String filename_cloud_gsm = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_gsm_regression.txt";
		...
		try {
			if(targetDatacenter == VehicularEdgeOrchestrator.EDGE_DATACENTER) {
				...
				// *******************
				//System.out.printf("handleRegression edge data: \n");
				//System.out.println(data);
				//System.out.printf("\n");
				try
				{
					FileWriter fw_edge = new FileWriter(filename_edge, true); //the true will append the new data
					String convertedToString = String.valueOf(data);
					fw_edge.write(convertedToString);
					fw_edge.write("\n");
					fw_edge.close();
				}
				...
				// *******************
				//System.out.printf("handleRegression cloud_rsu data: \n");
				//System.out.println(data);
				//System.out.printf("\n");
				try
				{
					FileWriter fw_cloud_rsu = new FileWriter(filename_cloud_rsu, true); //the true will append the new data
					String convertedToString = String.valueOf(data);
					fw_cloud_rsu.write(convertedToString);
					fw_cloud_rsu.write("\n");
					fw_cloud_rsu.close();
				}
				catch(IOException ioe)
				...
				// *******************
				//System.out.printf("handleRegression cloud_gsm data: \n");
				//System.out.println(data);
				//System.out.printf("\n");
				try
				{
					FileWriter fw_cloud_gsm = new FileWriter(filename_cloud_gsm, true); //the true will append the new data
					String convertedToString = String.valueOf(data);
					fw_cloud_gsm.write(convertedToString);
					fw_cloud_gsm.write("\n");
					fw_cloud_gsm.close();
				}
				catch(IOException ioe)
		...
		//System.out.printf("output of handleRegression: %f ", result);
	...
	public boolean handleClassification(int targetDatacenter, double[] values) {
		...
		String filename_edge = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_edge_classification.txt";
		String filename_cloud_rsu = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_rsu_classification.txt";
		String filename_cloud_gsm = "C:\\Users\\jafouche\\Documents\\Edge_computing\\Xmatrix_gsm_classification.txt";
		...
		try {
			if(targetDatacenter == VehicularEdgeOrchestrator.EDGE_DATACENTER) {
				...
				// *******************
				//System.out.printf("handleClassification cloud_gsm data: \n");
				//System.out.println(data);
				//System.out.printf("\n");
				try
				{
